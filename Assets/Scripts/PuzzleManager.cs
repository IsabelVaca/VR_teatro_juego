...
public class PuzzleManager : MonoBehaviour
{
    ...
    public GameObject puzzleCompletedText;
    ...
    private void Start()
    {
        ...
        if (puzzleCompletedText != null)
            puzzleCompletedText.SetActive(false);
    ...
    private void UnlockDoor()
    {
        ...
        // Aquí después pones lo de desbloquear/abrir la puerta.
    }
    ...
    private void CompletePuzzle()
    {
        ...
        if (puzzleCompletedText != null)
            puzzleCompletedText.SetActive(true);
